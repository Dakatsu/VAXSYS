...
ALTER TABLE appointment ADD CONSTRAINT FK_APPT_SLOT FOREIGN KEY (slot_id) REFERENCES slot (id);
ALTER TABLE appointment ADD CONSTRAINT FK_APPT_VACCINE FOREIGN KEY (vaccine_id) REFERENCES vaccine (id);
ALTER TABLE appointment ADD CONSTRAINT FK_APPT_ACCOUNT FOREIGN KEY (patient_id) REFERENCES account (id);
ALTER TABLE account ADD id_number VARCHAR(255);